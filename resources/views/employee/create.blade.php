                                ...
                                <div class="col-md-6">
                                    <select class="form-control" name="company">
                                        @foreach($compaines as $company)
                                            <option id="{{ $company->id }}" type="text" class="form-control @error('company') is-invalid @enderror" value="{{ $company->id }}" required autocomplete="company" autofocus> {{ $company->id }} </option>
                                        @endforeach
                                    </select>
                                    @error('company')
                                    <span class="invalid-feedback" role="alert">
